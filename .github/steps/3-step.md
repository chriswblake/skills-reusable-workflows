...
1. Under `Source` select `GitHub Actions`
    ...
    <img width="900" alt="image showing GitHub Pages settings" src="https://github.com/chriswblake/skills-reusable-workflows/blob/main/.github/images/pages-settings.png?raw=true" />
